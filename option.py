...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--data_path', type=str, default="D:\Documents\Dataset\Simclr\TCGA", help='path to dataset where images store')
        ...
        parser.add_argument('--model_path', type=str, default="results/simclr/tcga_resnet50_pretrained/saved_models", help='path to trained model')
        parser.add_argument('--log_path', type=str, default="results/simclr/tcga_resnet50_pretrained/runs", help='path to log files')
        ...
        parser.add_argument('--figure_path', type=str, default="results/simclr/tcga_resnet50_pretrained/curve", help='GraphCAM')
